    ...
    def operacoes(self):
        while(self.opcao != 1):
            ...
            if self.opcao == 1:
                ...
                num = int(input('Informe um número:'))
                print(self.modelo.exercicio1(num))
                ...
                print(f' A soma dos numeros entre 1 e 100 é: {self.modelo.exercicioTres()}')
                ...
                num = int(input("Informe um numero:"))
                print(f'a soma de {num é:} {self.modelo.exercicioQuize(num)}')
